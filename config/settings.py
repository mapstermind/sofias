...
MIDDLEWARE = [
    ...
    "apps.accounts.middleware.RequireProfileActivationMiddleware",
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "sofias"),
        "USER": os.environ.get("DB_USER", "sofias"),
        "PASSWORD": os.environ.get("DB_PASSWORD", "sofias"),
